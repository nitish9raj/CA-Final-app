...
# ── Module routing ───────────────────────────────────────────
if   "Dashboard"         in choice: from dashboard          import render_dashboard;          render_dashboard()
elif "Study Tracker"     in choice: from study_tracker      import render_study_tracker;      render_study_tracker()
elif "Syllabus"          in choice: from syllabus_tracker   import render_syllabus_tracker;   render_syllabus_tracker()
elif "Revision Schedule" in choice: from revision_schedule  import render_revision_schedule;  render_revision_schedule()
elif "Tests"             in choice: from tests_analytics    import render_tests_analytics;    render_tests_analytics()
elif "Daily Planner"     in choice: from daily_planner      import render_daily_planner;      render_daily_planner()
elif "Lecture"           in choice: from lecture_library    import render_lecture_library;    render_lecture_library()
elif "Practice"          in choice: from practice_generator import render_practice_generator; render_practice_generator()
elif "Exam Mapping"      in choice: from exam_mapping       import render_exam_mapping;       render_exam_mapping()
elif "AI Insights"       in choice: from ai_insights        import render_ai_insights;        render_ai_insights()
elif "AI File"           in choice: from ai_study_assistant import render_ai_study_assistant; render_ai_study_assistant()
elif "ICAI"              in choice: from icai_library       import render_icai_library;       render_icai_library()
