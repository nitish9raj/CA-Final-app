...
def render_login_page():
    ...
    <div style="text-align:center;margin-bottom:32px;padding-top:10px;">
      ...
      <div style="font-size:13px;color:{txt2};margin-top:6px;">
...
def _email_ui(t):
    ...
    if mode == "Sign In":
        ...
        st.markdown(f"<p style='color:{txt};font-weight:700;font-size:16px;'>Create your account 🚀</p>", unsafe_allow_html=True)
        ...
        st.markdown(f"<p style='color:{txt};font-weight:700;font-size:16px;'>Reset Password 🔑</p>", unsafe_allow_html=True)
...
def _otp_ui(t):
    txt = t["text"]
    st.markdown(f"<p style='color:{txt};font-weight:700;font-size:16px;'>Phone OTP Login 📱</p>", unsafe_allow_html=True)
...
def _google_ui(t):
    txt = t["text"]
    st.markdown(f"<p style='color:{txt};font-weight:700;font-size:16px;'>Sign in with Google</p>", unsafe_allow_html=True)
    ...
    <a href="{gurl}" target="_self" style="
        ...
        color:#3c4043;box-shadow:0 1px 4px rgba(0,0,0,0.12);">
